...
form.addEventListener("submit", (e) => {
    ...
    ${compliments[date - 1]}. ${victimCardCompliments[year % 20]}. Our Recommendation for You :${recommendations[(date * month) % 30]}.Your Future Prediction is:${predictions[(name.length * surname.length) % 20]}`
